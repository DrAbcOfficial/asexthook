...
void RegisterAngelScriptMethods(){
	...
	ASEXT_RegisterDocInitCallback([](CASDocumentation* pASDoc) {
		...
		REGISTE_OBJMETHODEX(reg, pASDoc, "Excute SQL In Sync", "CSQLite", "SQLiteResult Exec(string&in sql, array<string>@ aryResult, int&out iColumn, int&out iRow, string&out errMsg)", CASSQLite, ExecSync, asCALL_THISCALL);
